# CareSync - Doctor Appointment & Healthcare Web App
...
- Provides information about **CareSync’s vision** and mission.
...
├── admin/           # Provider & Admin Console (React.js)
├── ai-service/      # Fast-API Clinical Intelligence (Python)
