...
import { registerUser, loginUser, googleLogin, getProfile, updateProfile, bookAppointment, listAppointment, cancelAppointment, paymentRazorpay, verifyRazorpay, aiSymptomCheck, rescheduleAppointment, rateDoctor, aiChatbot, aiMedicineInfo, aiDietNutrition, aiReportSummary, aiFollowUp } from '../controllers/userController.js';
...
userRouter.post("/ai/symptom-check", aiSymptomCheck)
userRouter.post("/ai/chatbot", aiChatbot)
userRouter.post("/ai/medicine-info", aiMedicineInfo)
userRouter.post("/ai/diet-nutrition", aiDietNutrition)
userRouter.post("/ai/report-summary", aiReportSummary)
userRouter.post("/ai/follow-up", aiFollowUp)
