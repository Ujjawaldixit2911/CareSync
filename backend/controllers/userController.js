...
const aiChatbot = async (req, res) => {
    try {
        ...
        let fallbackReply = "I am here as your CareSync clinical assistant to guide you. While I can help you identify the right medical specialties for your symptoms (e.g., Dermatologist, Ophthalmologist, General Physician) and explain general wellness tips, please consult a certified doctor for formal diagnosis and treatment. For critical emergencies, please call emergency services immediately.";

        if (userMsg.includes("hello") || userMsg.includes("hi") || userMsg.includes("hey") || userMsg.includes("greeting")) {
            fallbackReply = "Hello! I am your CareSync clinical assistant. How can I help you today? You can ask me about common medical symptoms, doctor specialties, or guidance on booking appointments.";
