...
const loginAdmin = async (req, res) => {
    try {
        ...
        const isAdminEmailMatch = email === process.env.ADMIN_EMAIL || email === 'admin@caresync.com' || email === 'admin@healthverse.com'
        if (isAdminEmailMatch && password === process.env.ADMIN_PASSWORD) {
